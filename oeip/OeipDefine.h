...
#define OEIP_SUCESS 0
#define OEIP_AUDIOCODE 5000
#define OEIP_AUDIOCODEERROR(x) -(OEIP_AUDIOCODE+x)
#define OEIP_AUDIO_NOLOADFFMPEG OEIP_AUDIOCODEERROR(11)
#define OEIP_AUDIO_NORECORD OEIP_AUDIOCODEERROR(12)
