...
class OEIPWINDLL_EXPORT Dx11Resource
{
public:
	Dx11Resource() {};
...
class OEIPWINDLL_EXPORT Dx11CSResource :public Dx11Resource
{
public:
	Dx11CSResource() {};
...
class OEIPWINDLL_EXPORT Dx11Texture : public Dx11CSResource
{
public:
	Dx11Texture() {};
	virtual ~Dx11Texture();
...
public:
	void setTextureSize(int32_t width, int32_t height, DXGI_FORMAT format = DXGI_FORMAT_R8G8B8A8_UNORM);
protected:
	// 通过 Dx11Resource 继承
...
class OEIPWINDLL_EXPORT Dx11Buffer : public Dx11CSResource
{
public:
	Dx11Buffer() {};
	virtual ~Dx11Buffer();
...
class OEIPWINDLL_EXPORT Dx11Constant : public Dx11Resource
{
public:
	Dx11Constant() {};
...
class OEIPWINDLL_EXPORT Dx11SharedTex
{
public:
	Dx11SharedTex() {};
...
public:
	bool restart(ID3D11Device* deviceDx11, int32_t width, int32_t height, DXGI_FORMAT format = DXGI_FORMAT_R8G8B8A8_UNORM);
	void release();
};

class OEIPWINDLL_EXPORT ShaderInclude : public ID3DInclude
{
public:
